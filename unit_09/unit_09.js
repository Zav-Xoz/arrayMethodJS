...
// let a1 = [1, 11, 12, 13, 17, 55, 32, 23, 27, 26, 35, 72];
...
// let a2 = [1, 11, 12, 13, 17, 55];
let a2_from = 23;
let a2_to = 27;

const f2 = () => {
    let out = a2.find(item => {
...
let str4 = 'a_baba_galamaga_tvoe_khorito_est_nesti';
let a4_from = 'k';
let a4_to = 't';
...
const f7 = () => {
    // let str = str7.toLowerCase();
    // let letter = a7_1.toLowerCase();
    let out = str7.lastIndexOf(a7_1);
...
const f8 = () => {
    let str = str8.toLowerCase();
    let letter = a8_1.toLowerCase();
    let out = str.lastIndexOf(letter);
